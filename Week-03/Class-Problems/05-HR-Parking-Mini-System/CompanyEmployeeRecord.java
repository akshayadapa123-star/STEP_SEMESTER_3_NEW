    ...
    static class ParkingSlot {
        ...
        static void safeAllot(
            ...
            if (availableSlot != null) {
                ...
                availableSlot.allot(record.empId);
                record.slot = availableSlot;
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        CompanyEmployeeRecord divya =
                new CompanyEmployeeRecord(
                        "Divya", "E101", divyaEmployee);

        CompanyEmployeeRecord karan =
                new CompanyEmployeeRecord(
                        "Karan", "E102", karanEmployee);

        CompanyEmployeeRecord meera =
                new CompanyEmployeeRecord(
                        "Meera", "E103", meeraEmployee);
        ...
        ParkingSlot.safeAllot(slots, divya);
        ParkingSlot.safeAllot(slots, karan);
